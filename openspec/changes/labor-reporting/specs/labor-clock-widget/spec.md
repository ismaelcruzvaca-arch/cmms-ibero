# Labor Clock Widget Specification

## Purpose

Provide the UI component for mechanics to clock in and out against a work order with an activity code selector, embedded inside the WorkOrderDrawer.
