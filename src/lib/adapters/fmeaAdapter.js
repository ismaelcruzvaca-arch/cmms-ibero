...
export function toFmeaAnalysisViewModel(doc) {
  ...
  return {
    ...
    mitigation_actions: doc.mitigation_actions || '',
    recommended_frequency: doc.recommended_frequency || '',
...
export function prepareAnalysisForInsert(viewModel) {
  return {
    ...
    mitigation_actions: viewModel.mitigation_actions || '',
    recommended_frequency: viewModel.recommended_frequency || '',
